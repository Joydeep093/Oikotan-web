import { PAST_EVENTS, UPCOMING_EVENTS } from "@/data/event-data";
...
export const metadata: Metadata = {
  title: "Events",
  description:
    "Browse all upcoming and past events organized by Oikotan – Lithuanian cultural celebrations in the Netherlands.",
};

export default function EventsPage() {
  const upcoming = UPCOMING_EVENTS.sort(
    (a, b) => new Date(a.startDate).getTime() - new Date(b.startDate).getTime(),
  );
  const past = PAST_EVENTS.sort(
